...
char mqttClientName[21] = "P1P2_xxx";    // Must be unique, includes bridge name
#define MQTT_BRIDGE_NAME_IN_CLIENTNAME 5 // start of xxx for ip nr in MQTT_CLIENTNAME

// OTA
char OTA_HOSTNAME[25] = "P1P2MQTT_xxx";
#define OTA_BRIDGE_NAME_IN_HOSTNAME 9   // start of xxx for ip nr in OTA_HOSTNAME
